...
**Current Version:** v1.0.12-beta
**Current Phase:** Sprint 10 — Dashboard cleanup, owner Team Dashboard button, confirmation email template — COMPLETE
**Next Task:** Manual testing on localhost (verify MAIN MENU button removed, verify TEAM DASHBOARD button appears for owner role, paste confirm-signup email templates into Supabase dashboard)
