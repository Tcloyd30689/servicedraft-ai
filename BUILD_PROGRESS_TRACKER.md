...
**Current Phase:** Login Server-Side API Migration — COMPLETE
**Next Task:** Manual testing of login flow (login → main-menu, login while logged in → auto-redirect), then push to GitHub
