...
**Current Phase:** Sprint 4 — Theme display-name swap + light mode contrast fixes — COMPLETE
**Next Task:** Manual testing on localhost (verify theme names, light mode input contrast, light mode secondary button fill)
