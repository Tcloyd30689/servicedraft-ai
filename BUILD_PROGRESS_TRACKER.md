...
**Current Phase:** Sprint 7 — Refactor print export to use PDF viewer — COMPLETE
**Next Task:** Manual testing on localhost (verify VIEW / PRINT / DOWNLOAD button opens PDF in new tab from both ShareExportModal and NarrativeDetailModal)
