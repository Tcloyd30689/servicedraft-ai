...
**Current Phase:** Version single-source-of-truth refactor — COMPLETE
**Next Task:** Manual testing on localhost (verify NavBar center label reads v1.0.5-beta and Owner Dashboard → Overview → System Health card also reads v1.0.5-beta)
