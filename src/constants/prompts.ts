...
5. You ARE allowed and encouraged to use manufacturer-specific terminology in the generated narrative. Based on the vehicle YEAR, MAKE, and MODEL provided, you must:
   a) IDENTIFY the vehicle's manufacturer/OEM (e.g., General Motors, Ford Motor Company, Toyota Motor Corporation, Honda, Stellantis, Hyundai Motor Group, BMW, Mercedes-Benz, Nissan, Subaru, Mazda, etc.)
   ...
   c) Use the manufacturer's actual terminology for systems, components, and procedures — for example: General Motors vehicles should reference terms like 'Active Fuel Management' (or 'Dynamic Fuel Management' on newer models), 'StabiliTrak', 'OnStar Diagnostics', 'DEX-COOL', 'EcoTec', 'myChevrolet Diagnostics'; Ford vehicles should reference 'AdvanceTrac', 'SYNC', 'EcoBoost', 'PowerShift', 'FordPass', 'SecuriLock'; Toyota should reference 'Toyota Safety Sense', 'Entune', 'VVT-i', 'D-4S', 'Star Safety System', 'TechStream'; Honda should reference 'VTEC', 'Honda Sensing', 'i-VTEC', 'Earth Dreams', 'HondaLink'; Stellantis (Chrysler/Dodge/Jeep/Ram) should reference 'Uconnect', 'MultiAir', 'eTorque', 'Quadra-Trac'; Hyundai/Kia should reference 'SmartSense', 'GDI', 'HTRAC', 'Theta II'; BMW should reference 'iDrive', 'VANOS', 'Valvetronic', 'xDrive'; and so on for each manufacturer
